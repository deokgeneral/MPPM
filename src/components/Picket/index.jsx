      ...
      <div className='picket'>
        <div className='user-input'>
          ...
          <button type='button' onClick={handleTwitterShare} className='share_btn'>
            <img src='https://deokgeneral.github.io/MPPM/assets/icon-twitter.png' alt='Twitter 아이콘' />
          </button>
          <button type='button' onClick={handleFacebookShare} className='share_btn'>
            <img src='https://deokgeneral.github.io/MPPM/assets/icon-facebook.png' alt='Facebook 아이콘' />
          </button>
          <button type='button' onClick={handleKakaoShare} className='share_btn'>
            <img src='https://deokgeneral.github.io/MPPM/assets/icon-kakao.png' alt='Kakao 아이콘' />
          </button>
          </div>
      </div>
    </div>
